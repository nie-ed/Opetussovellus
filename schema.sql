...
CREATE TABLE answers (id SERIAL PRIMARY KEY, task_id INTEGER REFERENCES tasks, task_topic TEXT, student_id INTEGER REFERENCES users, sent_at TIMESTAMP, content TEXT, course_id INTEGER REFERENCES courses);
